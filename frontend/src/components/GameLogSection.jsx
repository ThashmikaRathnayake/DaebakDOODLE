    ...
    <div className="relative flex flex-col h-screen w-full items-center justify-between font-sans text-white overflow-hidden px-6 pt-4 pb-10">
      ...
      >
        <input
          ...
          className={`w-full px-4 py-3 rounded-xl border-2 border-white/30 bg-white/5 text-white placeholder-gray-300 focus:ring-2 focus:ring-pink-400/30 outline-none transition ${mode === "create" ? "focus:border-pink-400" : "focus:border-purple-400"}`}
        />
      </motion.div>
        ...
        {mode === "create" && (
          <div>
            ...
            <motion.button
              ...
              className="w-full mt-6 px-6 py-3 rounded-xl font-bold uppercase bg-gradient-to-r from-pink-400 via-pink-500 to-pink-400 text-white shadow-md transition-all duration-300"
            >
